...
<title>Listar Linha de Extensão</title>
		...
		<c:forEach var="linha" items="${requestScope.lista }">
			<tr>
				...
				<td>${linha.definicoes }</td>
					...
					<td><a href="Apoio.do?ref=editar&tipo=${requestScope.tipo }&id=${linha.id}"><button type="button" class="btn btn-warning right">Editar</button></a></td>
